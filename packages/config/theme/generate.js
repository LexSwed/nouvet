...
const lightColors = generateHslThemeFromMaterialThemeBuilder(mdTheme.schemes.light);
const darkColors = generateHslThemeFromMaterialThemeBuilder(mdTheme.schemes.dark);
...
await fs.writeFile(new URL("./global.css", import.meta.url), `${baseCss}\n${themeCss}`);
