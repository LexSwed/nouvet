const petsDict = {
	...
	"empty-activities.heading": "Keep everything that matters",
	...
	"new-activity.note.recorded-date.label": "Date of the event",
	...
	"new-activity.end-date.clear": "Clear date",
	...
	"new-activity.vaccine.due-date.intervals": "Common intervals",
	...
	"new-activity.appointment.note.label": "Main purpose",
	...
	"new-activity.appointment.location.description":
		"Address, or name of the medical centre, or doctor's name",
	"new-activity.prescription.name.label": "Name of the medication",
	"new-activity.prescription.dateStarted.label": "Start date",
	"new-activity.prescription.due-date.intervals": "Common intervals",
