const familyDict = {
  ...
  'delete-family-description': `By disbanding the family group, you will:<br/><ul class="list-disc"><li>Remove all members from the pet care circle.</li><li>Retain access to information for your own pets. Any data related to pets you don't own will be removed.</li></ul>`,
  'delete-family-cta': 'Disband Family',
  'delete-family-cancel': 'Cancel',
  'member.leave-family': 'Leave family',
  'invite-cta': 'Invite',
  'invite.back': 'Return',
