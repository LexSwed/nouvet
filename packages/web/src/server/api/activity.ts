...
export const getPetScheduledActivities = cache(async function getPetScheduledActivitiesServer(
	petId: PetID,
) {
	"use server";
...
export const listAllPetActivities = cache(async function listAllPetActivitiesServer(
