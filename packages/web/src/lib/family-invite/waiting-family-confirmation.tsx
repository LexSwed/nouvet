...
export function WaitingFamilyConfirmation(props: {
  ...
  return (
    <Card
      role="group"
      variant="flat"
      class="from-primary/5 border-on-surface/2 to-on-surface/2 flex flex-col gap-4 rounded-3xl border bg-transparent bg-gradient-to-br via-transparent via-60%"
    >
